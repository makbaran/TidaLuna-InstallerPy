...
# TidaLunaInstallerPy
A simple script written in Python for detecting your os, downloading, extracting, and installing [TidaLuna] mod files onto the Tidal client on Windows, Mac, and Linux (Currently in Development).
